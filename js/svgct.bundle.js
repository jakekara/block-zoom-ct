...
var find_slice = function(bbox)
{
	...
	// if (a.bbox[1] > coords[1]) return false;
	// if (a.bbox[2] < coords[0]) return false;
	// if (a.bbox[3] < coords[1]) return false;
	// return true;
    });
...
var make_zoomy = function()
{
	...
	.on("click", function(d){
		...
		for ( var i in layers )
		{
			...
			timeout = setTimeout(zoom_when_loaded, 200);
			return;
		    }
		}
...
},{"./smap.js":1,"d3":3,"topojson":4}],3:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.5.17"
  };
